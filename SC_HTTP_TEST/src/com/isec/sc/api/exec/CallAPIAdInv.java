...
public class CallAPIAdInv {
	...
	public static void main(String[] args) throws UnsupportedEncodingException {
        ...
        String[] arr_bar_code = {"GRA122A010BLML","GRA122A010BLML","GRA122A01GORML", "GRA122A01GORXSS"};
        Integer[] arr_stockQty = {10, 10, 1, 1};
		String[] arr_ship_node = {"Matrix_WH1","Matrix_WH2","Matrix_WH2","Matrix_WH2"};
